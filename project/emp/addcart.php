      ...
      <div class="row pb-4">
        <div class="container">
          <div class="row">
            ...
            $sql1 = "SELECT * FROM product WHERE num <> 0 ORDER BY RAND() LIMIT 4;";
                ...
                <div class="card text-center" style="width: 100%; height: 450px;">
                  ...
                  <div class="card-footer p-1 pt-0 border-top-0 bg-transparent">
                    ...
                    <?php } else { ?>
                      ...
                      <?php } else { ?>
                        <div class="text-center"> <a class="btn mt-auto text-white" target="_blank" href="addcart.php?ID=<?php echo $row1['product_id']; ?>" style="background-color: #ec407a;"><i class="bi-cart-fill me-1"></i> สั่งซื้อ</a></div>
                    <?php }
                    } ?>
                  </div>
                </div>
